import { AdminSettlementBillItem, AdminSettlementStatement } from './api';
...
export function buildSettlementCsv(statements: AdminSettlementStatement[]): string {
...
function settlementCsvRow(statement: AdminSettlementStatement, item: AdminSettlementBillItem | null) {
  return [
